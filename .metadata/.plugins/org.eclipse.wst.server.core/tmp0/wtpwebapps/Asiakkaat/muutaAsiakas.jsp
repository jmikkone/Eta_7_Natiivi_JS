...
<form id="tiedot">
 ...
 <input type="hidden" name="asiakas_id" id="asiakas_id"> <!-- jos asiakas_id:tä muutettaisiin: säilötään vanha asiakas_id, että nähdään mihin id:hen muutokset kohdistuu -->
</form>
