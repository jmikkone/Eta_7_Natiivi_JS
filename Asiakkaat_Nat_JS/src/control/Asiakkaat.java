...
// GET:ll‰ haetaan asiakkaan tiedot
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("application/json; charset=UTF-8"); //t‰ss‰ m‰‰ritell‰‰n sen kirjoituksen, joka tullaan kirjoittamaan, tyypiksi ("application/json; charset=UTF-8"); charset=UTF-8 on varmaan sit‰ varten, ett‰ skandit luetaan oikein?
